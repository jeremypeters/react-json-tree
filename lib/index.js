...
var JSONTree = (function(_React$Component) {
  ...
  JSONTree.prototype.shouldComponentUpdate = function shouldComponentUpdate(
    ...
    return !!(0, _keys2['default'])(nextProps).find(function(k) {
      return k === 'keyPath'
        ? nextProps[k].join('/') !== _this2.props[k].join('/')
        : nextProps[k] !== _this2.props[k];
    });
  };

  JSONTree.prototype.UNSAFE_componentWillReceiveProps = function UNSAFE_componentWillReceiveProps(
    nextProps
  ) {
    var _this3 = this;
    ...
    if (
      ['theme', 'invertTheme'].find(function(k) {
        return nextProps[k] !== _this3.props[k];
      })
    ) {
